 ...
 *
 * @example
 * new DataTypes.ENUM('value', 'another value')
 * new DataTypes.ENUM(['value', 'another value'])
 * new DataTypes.ENUM({
 ...
 *
 * @example
 * new DataTypes.ARRAY(DataTypes.DECIMAL)`.
 */
 ...
 * DataTypes.GEOMETRY
 * new DataTypes.GEOMETRY('POINT')
 * new DataTypes.GEOMETRY('POINT', 4326)
 *
 ...
 * DataTypes.GEOGRAPHY
 * new DataTypes.GEOGRAPHY('POINT')
 * new DataTypes.GEOGRAPHY('POINT', 4326)
 */
